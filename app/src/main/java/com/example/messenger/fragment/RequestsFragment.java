...
import com.example.messenger.model.RequestUser;
...
public class RequestsFragment extends Fragment {
   ...
   /* private View requestFragmentView;
    ...
    String list_user_id;
    List<RequestUser> requestUserList;
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot)
                            {
                                if (dataSnapshot.exists())
                                {
                                    ...
                                    else if (type.equals("sent"))
                                    {
                                        ...
                                        request_sent_btn.setText("Friend Request Sent");
...
/*
    ...
    public void onStart() {
        ...
        final FirebaseRecyclerAdapter<Contacts, RequestsViewHolder> adapter =
                new FirebaseRecyclerAdapter<Contacts, RequestsViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull final RequestsViewHolder holder, int i, @NonNull final Contacts contacts) {
                                    ...
                                    if (type.equals("received")) {
                                        ...
                                        usersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot childData) {
                                                if (childData.hasChild("image")) {
                                                    final String requestUserName = childData.child("name").getValue().toString();
                                                    final String requestUserStatus = childData.child("status").getValue().toString();
                                                    holder.userName.setText(requestUserName);
                                                    holder.userStatus.setText(requestUserStatus);
                                                    final String requestProfileImage = childData.child("image").getValue().toString();
                                                    Picasso.get().load(requestProfileImage).placeholder(R.drawable.images).into(holder.profileImage);
                                                                        ...
                                                                        contactRef.child(currentUserID).child(list_user_id).child("contact")
                                                                            ...
                                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                                if (task.isSuccessful()) {
                                                                                    ...
                                                                                    contactRef.child(list_user_id).child(list_user_id).child("contact")
                                                                                            .setValue("Saved").addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                        @Override
                                                                                        public void onComplete(@NonNull Task<Void> task) {
                                                                                            if (task.isSuccessful()) {
