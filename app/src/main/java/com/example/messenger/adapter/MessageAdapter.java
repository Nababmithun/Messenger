        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild("image")){
                    ...
                    Picasso.get().load(receiverImage).placeholder(R.drawable.detault_profile).into(holder.receiverProfileImage);
                }
            }
    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, int i)
    {
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.hasChild("image"))
                {
                    ...
                    Picasso.get().load(receiverImage).placeholder(R.drawable.detault_profile).into(messageViewHolder.receiverProfileImage);
                }
            }
        ...
        if (fromMessageType.equals("text"))
        {
            ...
            else
            {
                ...
                messageViewHolder.receiverMessageText.setBackgroundResource(R.drawable.receiver_messager_layout);
